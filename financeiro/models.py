...
class Pessoa(models.Model):
    ...
    municipio = models.CharField(max_length=50, default='')
    cep = models.CharField(max_length=20, help_text="Nao use caracteres especiais: <em>40353111</em", default=' ')
    uf = models.CharField(max_length=2, default='')
    telefone = models.CharField(max_length=20, help_text="Use o seguinte formato: <em>071999998888 ou 32220000</em>", default='')
...
class FornecedorPessoaFisica(PessoaFisica):
    cliente_fpf = models.ForeignKey(PessoaFisica, related_name='+')

    def __str__(self):
        return "%s " % (self.cliente)

class FornecedorPessoaJuridica(PessoaJuridica):
    cliente_fpj = models.ForeignKey(PessoaJuridica, related_name='+')
