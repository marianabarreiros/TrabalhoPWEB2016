...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='clienteFisico',
            field=models.ForeignKey(blank='True', default='None', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='financeiro.ClientePessoaFisica', verbose_name='Cliente Fisico'),
        ),
        migrations.AddField(
            model_name='lancamentosreceber',
            name='clienteJuridico',
            field=models.ForeignKey(blank='True', default='None', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='financeiro.ClientePessoaJuridica', verbose_name='Cliente Juridico'),
        ),
        migrations.AddField(
            model_name='lancamentosreceber',
            name='empresa',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank='True', default='None', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='financeiro.FornecedorPessoaFisica', verbose_name='Fornecedor Fisico'),
        ),
        migrations.AddField(
            model_name='lancamentospagar',
            name='fornecedorJuridico',
            field=models.ForeignKey(blank='True', default='None', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='financeiro.FornecedorPessoaJuridica', verbose_name='Fornecedor Juridico'),
        ),
        migrations.AddField(
            model_name='empresa',
            name='responsavel',
